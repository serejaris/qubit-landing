...
// Augment JSX.IntrinsicElements to include the Three.js elements used.
// This fixes TypeScript errors where these elements are not recognized on JSX.IntrinsicElements.
declare global {
  namespace JSX {
