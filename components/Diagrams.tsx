...
export const SurfaceCodeDiagram: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-white rounded-xl shadow-sm border border-stone-200 my-8">
      <h3 className="font-serif text-xl mb-4 text-stone-800">Интерактив: Обнаружение Поверхностного Кода</h3>
      <p className="text-sm text-stone-500 mb-6 text-center max-w-md">
        Нажмите на серые <strong>Кубиты данных</strong>, чтобы внести ошибки. Следите за тем, как цветные <strong>Стабилизаторы</strong> загораются, обнаруживая нечетное количество ошибок.
      </p>
      ...
      <div className="mt-6 flex items-center gap-4 text-xs font-mono text-stone-500">
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-full bg-stone-800"></div> Ошибка</div>
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-sm bg-blue-500"></div> Z-Проверка</div>
          <div className="flex items-center gap-1"><div className="w-3 h-3 rounded-sm bg-red-500"></div> X-Проверка</div>
      </div>
      
      <div className="mt-4 h-6 text-sm font-serif italic text-stone-600">
        {errors.length === 0 ? "Система стабильна." : `Обнаружено ${activeStabilizers.length} нарушений четности.`}
      </div>
    </div>
  );
};
...
export const TransformerDecoderDiagram: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center p-8 bg-[#F5F4F0] rounded-xl border border-stone-200 my-8">
      <h3 className="font-serif text-xl mb-4 text-stone-900">Архитектура AlphaQubit</h3>
      <p className="text-sm text-stone-600 mb-6 text-center max-w-md">
        Модель обрабатывает историю синдромов с помощью рекуррентного трансформера, уделяя внимание пространственным и временным корреляциям.
      </p>
      ...
      <div className="relative w-full max-w-lg h-56 bg-white rounded-lg shadow-inner overflow-hidden mb-6 border border-stone-200 flex items-center justify-center gap-8 p-4">
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">Синдром</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
             ...
             <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">Трансформер</span>
        </div>
        ...
        <div className="flex flex-col items-center gap-2">
            ...
            <span className="text-[10px] uppercase font-bold tracking-wider text-stone-500">Коррекция</span>
        </div>
    ...
    return (
        <div className="flex flex-col md:flex-row gap-8 items-center p-8 bg-stone-900 text-stone-100 rounded-xl my-8 border border-stone-800 shadow-lg">
            <div className="flex-1 min-w-[240px]">
                <h3 className="font-serif text-xl mb-2 text-nobel-gold">Производительность vs Стандарт</h3>
                <p className="text-stone-400 text-sm mb-4 leading-relaxed">
                    AlphaQubit стабильно достигает более низкого уровня логических ошибок (LER), чем стандартный декодер MWPM (Паросочетание минимального веса).
                </p>
                ...
                <div className="mt-6 font-mono text-xs text-stone-500 flex items-center gap-2">
                    ...
                    <span>УРОВЕНЬ ЛОГИЧЕСКИХ ОШИБОК (НИЖЕ - ЛУЧШЕ)</span>
                </div>
            </div>
            ...
            <div className="relative w-64 h-72 bg-stone-800/50 rounded-xl border border-stone-700/50 p-6 flex justify-around items-end">
                ...
                <div className="w-20 flex flex-col justify-end items-center h-full z-10">
                    ...
                    <div className="h-6 flex items-center text-xs font-bold text-stone-500 uppercase tracking-wider">Стандарт</div>
                </div>
